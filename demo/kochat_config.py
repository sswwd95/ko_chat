...
DATA = {
    ...
    'raw_data_dir': BASE['root_dir'] + "demo{_}data{_}raw{_}".format(_=_),  # 원본 데이터 파일 경로
    'ood_data_dir': BASE['root_dir'] + "demo{_}data{_}ood{_}".format(_=_),  # out of distribution 데이터셋
    'intent_data_dir': BASE['root_dir'] + "demo{_}data{_}intent_data.csv".format(_=_),  # 생성된 인텐트 데이터 파일 경로
    'entity_data_dir': BASE['root_dir'] + "demo{_}data{_}entity_data.csv".format(_=_),  # 생성된 엔티티 데이터 파일 경로
